package mince.steelarmory.init;

import mince.steelarmory.SteelArmory;
import mince.steelarmory.items.SteelArmoryHoe;
import mince.steelarmory.items.SteelBowItem;
import mince.steelarmory.toolmaterials.SteelArmorMaterial;
import mince.steelarmory.toolmaterials.SteelToolMaterial;
...
public class ItemsInit {
    ...
    public static ToolItem STEEL_HOE = new SteelArmoryHoe(STEEL_TM,2, 2f, new Item.Settings().group(ItemGroup.TOOLS));
    ...
    public static final Item STEEL_BOW = new SteelBowItem(new Item.Settings().maxCount(1).group(ItemGroup.COMBAT).maxDamage(431), 35);
    ...
    private static void registerItem(String path, Item item) {
        Registry.register(Registry.ITEM, SteelArmory.ID(path), item);
    }
}
